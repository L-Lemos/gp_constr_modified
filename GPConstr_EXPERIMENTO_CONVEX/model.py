...
class GPmodel():
    ...
    def optimize(self, include_constraint = True, fix_likelihood = False, bound_min = 1e-6, conditional = False, pc_alg = 'minimax_tilting', n = 100, opt_method = 'L-BFGS-B'):
        """
        ...
        if has_constr and include_constraint:
            ...
            self._optimize_constrained(fix_likelihood = fix_likelihood, bound_min = bound_min, conditional = conditional, algorithm = pc_alg, n = n, opt_method = opt_method)
            ...
            self._optimize_unconstrained(method = 'ML', fix_likelihood = fix_likelihood, bound_min = bound_min, opt_method = opt_method)
    ...
    def _optimize_unconstrained(self, method = 'ML', fix_likelihood = False, bound_min = 1e-6, opt_method = 'L-BFGS-B'):
        """
        ...
        # Run optimization
        if method == 'ML':
            res = self._optimize_unconstrained_ML(fix_likelihood, bound_min, opt_method)
        elif method == 'CV':
            print('TODO...')
    ...
    def _optimize_unconstrained_ML(self, fix_likelihood = False, bound_min = 1e-6, opt_method = 'L-BFGS-B'):
        """
